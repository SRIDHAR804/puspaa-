...
from OneloveMusic.utils.database import get_authuser_names, get_cmode
from OneloveMusic.utils.decorators import ActualAdminCB, AdminActual, language
from OneloveMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Onelove.stop_stream(message.chat.id)
    except:
        pass
