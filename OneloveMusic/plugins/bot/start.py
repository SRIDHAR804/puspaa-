...
from OneloveMusic import Telegram, YouTube, app
from OneloveMusic.misc import SUDOERS
from OneloveMusic.plugins.play.playlist import del_plist_msg
from OneloveMusic.plugins.sudo.sudoers import sudoers_list
...
from OneloveMusic.utils.decorators.language import LanguageStart
from OneloveMusic.utils.inline import help_pannel, private_panel, start_pannel
from OneloveMusic.utils.command import commandpro
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/Ourschennai) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
@app.on_message(commandpro(["/alive", "Onelove"]) & ~filters.edited)
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/279520d79f49aa7df3d47.jpg",
        caption=f"""━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ ʜᴇʟʟᴏ, Onelove ɪs ᴡᴏʀᴋɪɴɢ ᴀɴᴅ ғᴜɴᴄᴛɪᴏɴɪɴɢ ᴘʀᴏᴘᴇʀʟʏ\n✪ ᴛʜᴀɴᴋs ᴛᴏ 𝙾𝙽𝙴 𝙻𝙾𝚅𝙴 🌼 ..\n\n┏━━━━━━━━━━━━━━━━━┓\n┣★ ᴏᴡɴᴇʀ    : [Moni](https://t.me/king_of_Izzyy)\n┣★ ᴜᴘᴅᴀᴛᴇs › : [Onelove ʜᴇʟᴘ](https://t.me/king_of_Izzyy)┓\n┣★ ʀᴇᴘᴏ › : [Onelove ʀᴇᴘᴏ](https://github.com/king_of_Izzyy)\n┗━━━━━━━━━━━━━━━━━┛\n\n💞 ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴛʜᴇɴ\nᴅᴍ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](https://t.me/) ᴍᴀᴋᴇ sᴜʀᴇ ᴛᴏ sᴛᴀʀ ᴏᴜʀ ᴘʀᴏᴊᴇᴄᴛ ...\n\n━━━━━━━━━━━━━━━━━━━━━━━━
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🌼 Onelove ᴄʜᴀᴛ 💮", url=f"https://t.me/MELTING_MOOON"
                    )
                ]
            ]
        ),
